...
class DrawerPresentationController: UIPresentationController {
    ...
    convenience init(presentedViewController: UIViewController, presenting: UIViewController?, presentationType: PresentationType) {
    ...
    override var frameOfPresentedViewInContainerView: CGRect {
        ...
        case .right:
            frame = CGRect(x: UIScreen.main.bounds.width * 0.2, y: 0, width: UIScreen.main.bounds.width * 0.2, height: UIScreen.main.bounds.height)
        case .left:
            frame = .zero
        }
